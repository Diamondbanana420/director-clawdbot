...
- **NEVER use publicly exposed credentials** - Always require fresh, private credentials
- **Security > Convenience** - Protect user business even when they prefer shortcuts
- When in doubt, ask.
